...
class CusThresholdPercentField extends StatefulWidget {
  const CusThresholdPercentField(
      {super.key,
  ...
  @override
  State<CusThresholdPercentField> createState() => _CusThresholdCurrencyFieldState();
}

class _CusThresholdCurrencyFieldState extends State<CusThresholdPercentField> {
