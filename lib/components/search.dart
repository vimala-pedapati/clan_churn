...
// class ClanChurnSearchBar<T> extends StatefulWidget {
//   /// search bar with various customization option
//   const ClanChurnSearchBar(
...
// class MySingleChoiceSearchState<T> extends State<ClanChurnSearchBar<T?>> {
//   late List<T> _list;
...
//   @override
//   void didUpdateWidget(ClanChurnSearchBar oldWidget) {
//     if (oldWidget.searchList != widget.searchList) {
//       init();
//     }
//     // ignore: avoid_as
//     super.didUpdateWidget(oldWidget as ClanChurnSearchBar<T>);
//   }
...
//               hintText: (notifier.value ?? 'Search').toString(),
