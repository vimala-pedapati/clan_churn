...
class GetDialog {
  ...
  static Future<void> startedErrorReport(BuildContext context) async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return BlocBuilder<UserBloc, UserState>(
  ...
  static Future<void> preparingDownloadErrorReport(BuildContext context) async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            return const AlertDialog(
              title: Text("Preparing for download..."),
              content: SizedBox(
                  width: 400,
                  height: 200,
  ...
  static Future<void> startDownloadErrorReport(BuildContext context) async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return BlocBuilder<UserBloc, UserState>(
  ...
  static Future<void> endErrorReport(BuildContext context) async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return BlocBuilder<UserBloc, UserState>(
