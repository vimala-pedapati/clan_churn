...
class OutlinedButtonTemplate extends StatefulWidget {
  const OutlinedButtonTemplate({super.key, required this.icon, required this.title, required this.onPressed, this.onHoverTextChange});
  final IconData icon;
  final String title;
      ...
      child: SizedBox(
        ...
        child: OutlinedButton(
          style: OutlinedButton.styleFrom(
            ...
            side: BorderSide(
              color: widget.onPressed == null ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.primary,
              width: 1.5,
            ), // Adjust the border side
